...
.PHONY: ensure-private-dir
ensure-private-dir:
	docker compose exec -T drupal with-contenv bash -lc 'mkdir -p /var/www/drupal/private && chown nginx:nginx /var/www/drupal/private'

.PHONY: ensure-default-files-dir
ensure-default-files-dir:
	docker compose exec -T drupal bash -c "mkdir -p /var/www/drupal/web/sites/default/files && chown -R nginx:nginx /var/www/drupal/web/sites/default/files"
...
starter-finalize:
	...
	$(MAKE) ensure-private-dir
	$(MAKE) ensure-default-files-dir
